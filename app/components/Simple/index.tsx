    ...
    return (
        <div className="simple-bg relative">
            ...
            <div className="mx-auto max-w-5xl py-24 px-6">
                <h3 className="text-center text-offwhite text-3xl lg:text-5xl font-semibold mb-6">Calling All Game Dev Wizards <br />Unleash Your Creativity with VBG!</h3>
                <p className="text-center text-bluish text-lg font-normal mb-8">Join our passionate team of crazy minds and craft immersive gaming experiences that captivate players worldwide. Embrace the challenge, push the boundaries, and let your talents soar with VBG. Your dream game awaits! </p>
